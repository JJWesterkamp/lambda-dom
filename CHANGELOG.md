...
- Removed obsolete `package-lock.json` file in favor of `yarn.lock`.
...
[Unreleased]: https://github.com/JJWesterkamp/lambda-dom/compare/v2.1.1...HEAD
[2.1.1]: https://github.com/JJWesterkamp/lambda-dom/compare/v2.1.0...v2.1.1
